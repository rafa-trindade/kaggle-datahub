...
PARQUET_FINAL_PATH = os.path.join(base_dir, "data", "raw", "raw_sim_declaracao_obito_prelim.parquet")
CSV_TEMP_PATH = os.path.join(base_dir, "data", "raw", "raw_sim_declaracao_obito_prelim_temp.csv")
