...
PARQUET_FINAL_PATH = os.path.join(base_dir, "data", "raw", "raw_sistema_info_mortalidade.parquet")
CSV_TEMP_PATH = os.path.join(base_dir, "data", "raw", "raw_sistema_info_mortalidade_temp.csv")
